...
class AppColors {
  // Primary Colors
  static const Color primaryColor = Color(0xFF800080);
  static const Color primaryLight = Color(0xFF9D4EDD);
  static const Color primaryDark = Color(0xFF5A0060);
  
  // Secondary Colors
  static const Color secondaryColor = Color(0xFFFF6B9D);
  static const Color accentColor = Color(0xFF4ECFFF);
  ...
  // Button Colors
  static const Color buttonPrimaryColor = Color(0xFF800080);
  static const Color buttonTextColor = Colors.white;
  
  // Icon Colors
  static const Color iconPrimaryColor = Color(0xFF800080);
  static const Color iconSecondaryColor = Colors.grey;
